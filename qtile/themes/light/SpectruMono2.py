...
def init_widgets_list():
  widgets_list = [
    ...
    widget.TextBox(
      decorations=[RectDecoration(colour=bg, radius=[7,0,0,7], filled=True)],
      foreground=fg,
      text="",
      font=symbols_font,
    ),
    ...
    widget.CPU(
      decorations=[RectDecoration(colour=bg, radius=[0,7,7,0], filled=True)],
      foreground=fg,
      format='{load_percent}%'
    ),
    ...
    widget.Pomodoro(
      decorations=[RectDecoration(colour=bg, radius=7, filled=True)],
      foreground=fg,
      color_active=fg,
      color_break=fg,
      color_inactive=fg,
    ...
    widget.WidgetBox(
      decorations=[RectDecoration(colour=bg, radius=4, filled=True)],
      text_closed='',
      text_open='',
      foreground=fg,
      width=26,
    ...
    widget.GroupBox(
      decorations=[RectDecoration(colour=bg, radius=8, filled=True)],
      fontsize=groups_font,
      disable_drag=True,
      hide_unused=hide_unused_groups,
      borderwidth=0,
      active=tbg, #Program opened in that group
      inactive=tfg, # Empty Group
      rounded=False,
      highlight_method="text",
      this_current_screen_border=fg,
      center_aligned = True,
      other_curren_screen_border=fg,   
    ...
    *([widget.Spacer(
    ...
    widget.Wlan(
      decorations=[RectDecoration(colour=bg, radius=0, filled=True)],
      interface=wifi,
      format='{essid}',
